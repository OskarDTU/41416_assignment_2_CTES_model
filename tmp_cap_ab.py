...
for cap in [0.021, 0.03]:
    res = simulate(window, initial_no_load_hours=0.0, respect_factory_schedule=True, factory_off_on_weekends=False, disable_flow_rate_limits=False, max_ctes_flow_m3s=cap, debug=False, interactive=False)
