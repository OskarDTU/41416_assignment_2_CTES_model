...
window = dni.loc['2026-07-11 10:00:00+00:00':'2026-07-11 14:00:00+00:00']
...
sel2 = sel[(sel['collector_t_out_C'] >= 309.9) & (sel['m_col_vol_flow_m3s'] < 0.020)]
print('rows no-load+curtailed:', len(sel))
print('rows maxTout+flow<0.02:', len(sel2))
