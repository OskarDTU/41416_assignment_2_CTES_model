...
prio = simulate(window, initial_no_load_hours=0.0, respect_factory_schedule=True, factory_off_on_weekends=False, disable_flow_rate_limits=False, max_ctes_flow_m3s=0.021, early_sun_charge_priority=True, early_sun_collector_overdrive_factor=1.35, debug=False, interactive=False)
